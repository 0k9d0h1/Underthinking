...
def get_gpt4o_answer(question):
    ...
    for i in range(10):
        try:
            ...
            model="gpt-4.1-mini",
            messages=[
                {"role": "system", "content": "You are an AI evaluating answers."},
...
with open(output_file, "a", encoding="utf-8") as f, open(input_file, "r", encoding="utf-8") as infile:
    for i, line in enumerate(tqdm(infile)):
        ...
        answer = data["model_response"][-200:]
...
1. Evaluate the correctness of the answer referencing the ground truth that I will provide.
2. First, provide your reasoning process and then write correct/incorrect in the last line.

Your output format should be:
<Your reasoning process>
The correctness of the answer is: correct/incorrect
