...
def _default_compute_score(data_source, solution_str, ground_truth, extra_info=None, sandbox_fusion_url=None, concurrent_semaphore=None):
    ...
    elif data_source in ["lighteval/MATH", "DigitalLearningGmbH/MATH-lighteval", "Maxwell-Jia/AIME_2024", "HuggingFaceH4/MATH-500", "yentinglin/aime_2025", "math-ai/minervamath", "Hothan/OlympiadBench"]:
        from . import math
