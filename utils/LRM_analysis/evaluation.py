...
def main():
    ...
    parser.add_argument('--model_name', help='Name of the model', default='deepseek-ai/DeepSeek-R1-Distill-Qwen-7B')
    parser.add_argument('--dataset_name', help='Name of the dataset', default='AIME_2024')
