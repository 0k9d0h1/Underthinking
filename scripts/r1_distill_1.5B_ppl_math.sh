...
CUDA_VISIBLE_DEVICES=4,5 python3 -m verl.trainer.main_ppo \
    ...
    trainer.project_name='ppl_reward_test' \
    trainer.experiment_name='r1_distill_1.5B_ppl_math' \
    trainer.n_gpus_per_node=2 \
    trainer.nnodes=1 \
    trainer.default_local_dir=/home/kdh0901/Desktop/cache_dir/kdh0901/checkpoints/ppl_reward_test \
    trainer.validation_data_dir=/home/kdh0901/Desktop/cache_dir/kdh0901/val_data/ppl_reward_test \
    trainer.save_freq=2 \
