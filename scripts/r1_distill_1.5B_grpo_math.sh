...
CUDA_VISIBLE_DEVICES=4,5 python3 -m verl.trainer.main_ppo \
    ...
    trainer.project_name='base_rlvr' \
    trainer.experiment_name='r1_distill_1.5B_base_math' \
    trainer.n_gpus_per_node=2 \
    trainer.nnodes=1 \
    trainer.default_local_dir=/home/kdh0901/Desktop/cache_dir/kdh0901/checkpoints/base_rlvr \
    trainer.validation_data_dir=/home/kdh0901/Desktop/cache_dir/kdh0901/val_data/base_rlvr \
    trainer.save_freq=4 \
